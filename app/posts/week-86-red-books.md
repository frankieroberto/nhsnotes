---
title: "Week 86: Red books"
date: 2026-03-01
description: Notes on checking MMR vaccination history after a measles outbreak in North London.
image:
  src: /images/red-books.jpeg
  alt: "Photo of two A5-sized red books stacked on top of each other, with the cover containing the tile 'My personal child health record' and a drawing of a teddy bear."
  opengraphImage: true
---
...
The message linked to a PDF of a letter from [our local Integrated Care Board](https://nclhealthandcare.org.uk) (ICB) which tell us to:

1. Learn about the signs and symptoms of measles
2. Check if our children (and us) have had the MMR vaccination
3. Arrange MMR vaccination if needed, either through the GP or at one of the [local catch up clinics](https://www.schoolvaccination.uk/catch-up-clinics)
...
If you’ve set up [proxy access](https://www.nhs.uk/nhs-services/gps/gp-services-for-someone-else-proxy-access/what-is-proxy-access/) for your children (which itself [is a bit of a faff](/posts/week-19-platformland/#proxy-access)), you can instead check their vaccination history within the NHS app. To do this you have to select ‘Manage health services for others’, select a child, then go to the GP health record section and look under ‘Immunisations’.
...
* [Transforming health and delivering the NHS 10-year plan](https://www.rpp.works/ways-of-doing/talk-transforming-health-and-delivering-the-nhs-10-year-plan/) from Richard Pope
* [Can Test & Learn methods save the NHS?](https://medium.com/@jamestplunkett/test-and-learn-in-healthcare-7f0da4697a0d) from James Plunkett
* [Healthcare is an infinite game, but we’re playing with the wrong rules](https://medium.com/@teropsv/healthcare-is-an-infinite-game-but-were-playing-with-the-wrong-rules-03cd67b1a96d) from Tero Väänänen
* [Progressive Data Enhancement](https://abscond.org/2026/02/07/progressive-data-enhancement) from James Darling
